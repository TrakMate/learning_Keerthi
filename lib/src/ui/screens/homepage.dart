...
const List<List<String>> _lyricSets = [
  [
...
class _LyricTicker extends StatefulWidget {
  final int cardIndex;
  final bool big;
  const _LyricTicker({required this.cardIndex, this.big = false});

  @override
  State<_LyricTicker> createState() => _LyricTickerState();
}

class _LyricTickerState extends State<_LyricTicker> {
  ...
  void initState() {
    super.initState();
    _lines = _lyricSets[widget.cardIndex % _lyricSets.length];
